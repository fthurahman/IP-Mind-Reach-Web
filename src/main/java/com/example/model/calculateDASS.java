...
public class calculateDASS {
    ...
    public DASS calculate(int[] scores) {
        ...
        return new DASS(totalDepression,totalAnxiety,totalStress,interpretDepression(totalDepression),interpretAnxiety(totalAnxiety),interpretStress(totalStress));
    }
