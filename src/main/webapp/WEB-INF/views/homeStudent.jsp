        ...
        <body>
            ...
            <header class="header">
                <div class="header-container">
                    <!-- Logo -->
                    <a href="homeStudent" class="logo-btn">
                        MindReach
                    </a>

                    <!-- Desktop Navigation -->
                    <nav class="nav-desktop">
                        <a href="homeStudent" class="nav-item active">Self-Help</a>
            ...
            <div id="mobileSheet" class="sheet-overlay">
                <div class="sheet-content">
                    ...
                    <nav class="mobile-nav">
                        <a href="homeStudent" class="mobile-nav-item active">Self-Help</a>
            ...
            <main class="dashboard-content">
                ...
                <div style="text-align: center; margin-bottom: 3rem;">
                    <h1
                        style="font-family: var(--font-family-serif); font-size: 2.5rem; color: var(--foreground); margin-bottom: 0.5rem;">
                        Mental Health Self-Assessment</h1>
                    <p style="color: var(--muted-foreground);">Take the first step towards understanding your mental
                        wellbeing</p>
                </div>
                ...
                <div style="display: flex; justify-content: center; gap: 2rem; flex-wrap: wrap;">
                    ...
                    <!-- DASS Card -->
                    <div
                        style="background: white; padding: 2rem; border-radius: 1rem; width: 100%; max-width: 380px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); border: 1px solid var(--border);">
                        <div style="font-size: 2rem; margin-bottom: 1rem;">⚡</div>
                        <h3
                            style="margin-top: 0; font-family: var(--font-family-serif); font-size: 1.5rem; margin-bottom: 0.5rem;">
                            Depression, Anxiety & Stress Scale</h3>
                        <p
                            style="color: var(--card-foreground); font-size: 0.875rem; line-height: 1.5; margin-bottom: 1.5rem;">
                            Measure the current mental health and emotional states, identifying Depression, Anxiety or
                            Stress.
                        </p>
                        <a href="DASS"
                            style="display: block; width: 100%; padding: 0.75rem; text-align: center; background: var(--primary); color: var(--primary-foreground); text-decoration: none; border-radius: 0.5rem; font-weight: 500; transition: background 0.2s;">
                            Start Assessment →
                        </a>
                    </div>
                    ...
                    <div
                        ...
                        <h3
                            style="margin-top: 0; font-family: var(--font-family-serif); font-size: 1.5rem; margin-bottom: 0.5rem;">
                            Patient Health Questionnaire</h3>
                        <p
                            style="color: var(--card-foreground); font-size: 0.875rem; line-height: 1.5; margin-bottom: 1.5rem;">
                            Screen for presence and severity of depression. For diagnosis, professional consultation is
                            recommended.
                        </p>
                        <a href="assessmentPHQ"
                            style="display: block; width: 100%; padding: 0.75rem; text-align: center; background: var(--primary); color: var(--primary-foreground); text-decoration: none; border-radius: 0.5rem; font-weight: 500; transition: background 0.2s;">
                            Start Assessment →
                        </a>
                    </div>
