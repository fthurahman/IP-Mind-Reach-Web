                ...
                <header class="bg-white border-b border-[#E9E4DF] sticky top-0 z-50 h-[72px] flex justify-center">
                    <div class="w-full max-w-[1200px] px-8 flex items-center justify-between h-full">
                        ...
                        <nav class="hidden lg:flex items-center gap-6">
                            ...
                            <!-- Student Assessment (Active) -->
                            <a href="${pageContext.request.contextPath}/counselor/student-results"
                                class="text-sm text-[#2D2A28] font-semibold border-b-2 border-[#B4C59B] pb-1 transition-all">Student
                                Assessment</a>
                        </nav>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <fmt:formatDate value="${res.assessment_date}" pattern="dd MMM yyyy, hh:mm a" />
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="bg-yellow-50/50 rounded-xl p-4">
                                        <div class="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">
                                            Anxiety</div>
                                        <div class="flex items-baseline gap-2">
                                            <span class="text-2xl font-bold text-gray-800">${res.anxiety_score}</span>
                                            <span class="text-sm font-medium
                                    ...
                                    <div class="bg-blue-50/50 rounded-xl p-4">
                                        <div class="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">
                                            Stress</div>
                                        <div class="flex items-baseline gap-2">
                                            <span class="text-2xl font-bold text-gray-800">${res.stress_score}</span>
                                            <span class="text-sm font-medium
