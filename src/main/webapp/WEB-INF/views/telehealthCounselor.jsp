            ...
            <body class="bg-[#F7F3EF] min-h-screen">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <c:forEach var="appointment" items="${appointments}">
                                <c:if test="${appointment.status == 'upcoming' || appointment.status == 'in_progress'}">
                    ...
                    <div class="modal-content p-6 max-w-lg w-full mx-4">
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 mb-4">
                            <div class="flex items-center gap-3 mb-3">
                                <div class="w-12 h-12 rounded-full bg-[#B4C59B]/20 flex items-center justify-center">
                ...
                <div id="completeModal" class="modal">
                    <div class="modal-content p-6 max-w-lg w-full mx-4">
                        ...
                        <form action="${pageContext.request.contextPath}/telehealthCounselor/complete" method="post">
                            ...
                            <div class="bg-gray-50 rounded-xl p-4 mb-4">
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <div>
                                        <p class="font-medium text-[#3D3A37]" id="completeStudentName">Student Name</p>
                                        <span
                                            class="bg-[#CADBB7] text-[#3D3A37] px-2 py-0.5 rounded-full text-xs">Upcoming</span>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label class="block text-sm font-medium text-[#3D3A37] mb-2">Session Summary <span
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-[#3D3A37] mb-2">Recommendations</label>
                ...
                <div id="notesModal" class="modal">
                    <div class="modal-content p-6 max-w-lg w-full mx-4">
                        ...
                        <form action="${pageContext.request.contextPath}/telehealthCounselor/updateNotes" method="post">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label class="block text-sm font-medium text-[#3D3A37] mb-2">Session Summary</label>
