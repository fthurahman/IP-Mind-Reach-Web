      ...
      <body>
        ...
        <div id="createPostModal" class="dialog-backdrop">
          <div class="dialog-content" style="max-width: 500px;">
            <h2 class="dialog-title" style="text-align: left; margin-bottom: 0.25rem;">Create a New Post</h2>
            ...
            <form action="forum" method="post">
              ...
              <div class="form-group">
                ...
                <div class="input-wrapper">
                  ...
                  <select id="topic" name="topic" required
                    style="width: 100%; padding: 0.75rem; border-radius: var(--radius-xl); border: 1px solid var(--border); font-family: var(--font-family-sans); background: white;">
              ...
              <div class="form-group">
                ...
                <textarea id="content" name="content" rows="5" placeholder="Share your thoughts..." required
                  style="width: 100%; padding: 0.75rem; border-radius: var(--radius-xl); border: 1px solid var(--border); font-family: var(--font-family-sans); resize: vertical; box-sizing: border-box;"></textarea>
              </div>

              <div
                style="background-color: #EFF6FF; padding: 0.75rem; border-radius: var(--radius-xl); font-size: 0.875rem; color: #4B5563; margin-bottom: 1.5rem;">
                💡 Your post will be anonymous.
              </div>

              <div class="dialog-actions">
                <button type="button" class="btn-outline" onclick="closeCreateModal()">Cancel</button>
                <button type="submit" class="btn-primary" style="box-shadow: none;">Post Anonymously</button>
              </div>
            </form>
          </div>
        </div>
