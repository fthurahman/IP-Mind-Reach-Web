				...
				<main class="max-w-[1200px] mx-auto px-6 pb-8 pt-4 space-y-6">
					...
					<div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
						...
						<div class="bg-white rounded-xl p-1 flex flex-wrap shadow-[0_4px_12px_rgba(180,197,155,0.1)]">
							<a href="${pageContext.request.contextPath}/homeMProfessional?topic=all"
							...
							<a href="${pageContext.request.contextPath}/homeMProfessional?topic=anxiety"
							...
							<a href="${pageContext.request.contextPath}/homeMProfessional?topic=stress"
							...
							<a href="${pageContext.request.contextPath}/homeMProfessional?topic=sleep"
							...
							<a href="${pageContext.request.contextPath}/homeMProfessional?topic=depression"
							...
							<a href="${pageContext.request.contextPath}/homeMProfessional?topic=mindfulness"
							...
							<a href="${pageContext.request.contextPath}/homeMProfessional?topic=self-esteem"
						...
						<!-- Search -->
						<form action="homeMProfessional" method="GET" class="relative w-full sm:w-64">
