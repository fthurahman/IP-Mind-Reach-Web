                    ...
                    <c:if test="${p.status eq 'pending'}">
                      ...
                      <div class="listItem" data-post-id="${p.id}">
                        <div style="flex: 1">
                          ...
                          <div class="small">
                            <fmt:formatDate value="${p.date}" pattern="MMM d, hh:mm a" />
                          </div>
                          ...
                          <div class="actions">
                            <button class="btn" onclick="moderate('${p.id}','hide')">
                              Hide
                            </button>
                            <button class="btn danger" onclick="moderate('${p.id}','remove')">
                              Remove
                            </button>
                            <button class="btn" onclick="moderate('${p.id}','approve')">
                              Approve
                            </button>
                          </div>
                        </div>
